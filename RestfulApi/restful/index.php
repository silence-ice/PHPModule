...
class Restful{
	...
	/**
	 * 初始化请求方法
	 * @request http://127.0.0.1/RestfulApi/restful/index.php/article
	 * @return  打印$SERVER变量输出：'REQUEST_METHOD' => string 'GET'
	 */
	 ...
	 * 初始化请求资源
	 * @request http://127.0.0.1/RestfulApi/restful/index.php/article
	 * @return  打印$SERVER变量输出： 'PATH_INFO' => string '/article'
	 */
