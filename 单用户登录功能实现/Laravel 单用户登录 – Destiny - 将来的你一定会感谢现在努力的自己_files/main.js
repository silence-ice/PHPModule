...
var blackcandy = (function () {
    ...
    var handleSearch = function () {
        ...
        $(".search-button").click(function () {
            ...
            if ($(this).find("i").hasClass("czs-search-l")) {
                $(this).find("i").removeClass("czs-search-l").addClass("czs-close-l");
            } else {
                $(this).find("i").removeClass("czs-close-l").addClass("czs-search-l");
            }
        });
    };
    ...
    var setLayoutType = function () {
        $(".layout-type-wrap").bind({
            mouseenter: function() {
                $(this).addClass("layout-type-wrap-animate");
            },mouseleave: function() {
                $(this).removeClass("layout-type-wrap-animate");
            }
        });
